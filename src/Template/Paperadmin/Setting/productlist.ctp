                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Product Data</h4>
								 <?= $this->Flash->render() ?>
                               <a href="<?php echo $this->Url->build(['controller'=>'setting','action'=>'addproduct']);?>" style="float:right;" class="btn waves-effect waves-light btn-rounded btn-primary" >Create </a>
								...
								<?php if(count($productdata)>0){ ?>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
										<?php foreach($productdata as $product){  $product_id=$product['id'];?>
                                            <tr>

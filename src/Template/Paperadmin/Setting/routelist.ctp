                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control route_name"  name="route_name">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control route_code"  name="route_code">
                                            ...
                                            <div class="modal-footer">
												...
												<input type="submit" class="btn btn-danger waves-light route_form" value="Save"/>
                                            </div>
											</form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
													...
													<div class="form-group">
                                                        ...
                                                        <input type="text" value=0  onkeyup="if (/\D/g.test(this.value))  this.value = this.value.replace(/\D/g,'')" maxlength="5" class="form-control edit_delivery_charges" name="delivery_charge">
                                                    </div>
                                            ...
                                            <div class="modal-footer">
												...
												<input type="submit" class="btn btn-danger waves-light edit_route_form" value="Save"/>
                                            </div>
											</form>
                                        </div>
                                    </div>
								...
								<?php if(count($routedata)>0){ ?>
                                    <table class="table table-bordered">
										...
										<tr>
                                                ...
                                                <td><?php echo "Rs ".$route['delivery_charge'];?></td>

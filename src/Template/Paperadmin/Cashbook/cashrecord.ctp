                            ...
                            <div class="card-body">
						    	...
						    	<div class="col-md-6">
                                                   <div class="form-group has-success">
                                                    ...
                                                    <select class="form-control custom-select">
                                                        <option value="">Near Busstand</option>
										...
										<button type="submit" style="float:right" class="btn btn-success"> <i class="fa fa-check"></i> Search</button>
                                </div>
								<div>
								<div class="row">
